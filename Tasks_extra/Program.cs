...
//Console.WriteLine($"Числа в массиве чётные? - {IsEven(array)}"); // Ответ с true or false
...
// Console.WriteLine($"Числа в массиве идут по возрастанию? - {IsAscending(array)}"); // Ответ с true or false